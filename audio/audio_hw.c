...
#define NORMAL_SPEAKER_VOLUME_TORO 12
#define NORMAL_SPEAKER_VOLUME_MAGURO 11
#define NORMAL_HEADSET_VOLUME_TORO -6
#define NORMAL_HEADSET_VOLUME_MAGURO -6
#define NORMAL_HEADPHONE_VOLUME_TORO -6 /* allow louder output for headphones */
#define NORMAL_HEADPHONE_VOLUME_MAGURO -6
#define NORMAL_EARPIECE_VOLUME_TORO 4
#define NORMAL_EARPIECE_VOLUME_MAGURO 4

#define VOICE_CALL_SPEAKER_VOLUME_TORO 10
#define VOICE_CALL_SPEAKER_VOLUME_MAGURO 9
#define VOICE_CALL_HEADSET_VOLUME_TORO 0
#define VOICE_CALL_HEADSET_VOLUME_MAGURO 0
#define VOICE_CALL_EARPIECE_VOLUME_TORO 6

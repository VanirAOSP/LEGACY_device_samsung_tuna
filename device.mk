...
PRODUCT_COPY_FILES += \
		...
		#device/samsung/tuna/init.zram:root/sbin/init.zram \
...
PRODUCT_COPY_FILES += \
        ...
        frameworks/native/data/etc/android.hardware.audio.low_latency.xml:system/etc/permissions/andr

## AOSP didn't have this, so now WE DON'T EITHER MUAHAHAHAHA
